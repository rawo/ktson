...
This directory contains comprehensive documentation for the KtSON JSON Schema validator library.
...
- **[COMPLETION_SUMMARY.md](COMPLETION_SUMMARY.md)** - Original project completion summary
...
- **[REF_USAGE_EXAMPLES.md](REF_USAGE_EXAMPLES.md)** - Practical examples of using $ref
...
- **JSON Schema Versions**: Draft 2019-09 and Draft 2020-12
- **Thread Safety**: ✅ Fully thread-safe
- **$ref Support**: ✅ Complete implementation
...
- See [REF_USAGE_EXAMPLES.md](REF_USAGE_EXAMPLES.md) for code examples
- Read [GRAPHEME_CLUSTER_ISSUE.md](GRAPHEME_CLUSTER_ISSUE.md) for Unicode edge cases
- Review [OFFICIAL_TEST_SUITE_RESULTS.md](OFFICIAL_TEST_SUITE_RESULTS.md) for validation compliance
